$(document).ready(function() {
   const apiRoot = 'https://kodilla-tasks-gt.herokuapp.com/v1/';
   const trelloApiRoot = 'https://kodilla-tasks-gt.herokuapp.com/v1/trello/';
   ...
   function handleTaskDeleteRequest() {
      ...
      $.ajax({
         url: requestUrl + '/' + taskId,// $.param({taskId: taskId}),
         method: 'DELETE',
         success: function() {
